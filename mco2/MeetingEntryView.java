...
public class MeetingEntryView {
    private JPanel panel, datePanel, entryTitlePanel, startTimePanel, endTimePanel, modalityPanel, venuePanel, linkPanel, descriptionPanel, addPanel;
    private JLabel titleLbl, dateLbl, entryTitleLbl, startTimeLbl, endTimeLbl, modalityLbl, venueLbl, linkLbl, descriptionLbl, errorLbl;
    private JTextField entryTitleTf, venueTf, linkTf;
    ...
    private JPanel dateTitlePanel, startEndTimePanel, modalityVenuePanel;
    private JSeparator separator;

    public MeetingEntryView() {
        this.panel = new JPanel();
        this.panel.setLayout(new BoxLayout(this.panel, BoxLayout.Y_AXIS));

        // title label
        this.titleLbl = new JLabel("Add Meeting Entry");
        ...
        // modality label
        this.modalityLbl = new JLabel("Modality:");
        this.modalityLbl.setPreferredSize(new Dimension(140, 50));
        this.modalityLbl.setMaximumSize(new Dimension(140, 50));
        this.modalityLbl.setMinimumSize(new Dimension(140, 50));
        this.modalityLbl.setFont(new Font("Century Gothic", 0, 24));
        this.modalityLbl.setForeground(new Color(51, 51, 51));

        // modality combo box
        this.modalityBox = new JComboBox<>();
        this.modalityBox.setPreferredSize(new Dimension(240, 50));
        this.modalityBox.setMaximumSize(new Dimension(240, 50));
        this.modalityBox.setMinimumSize(new Dimension(240, 50));
        this.modalityBox.setFont(new Font("Century Gothic", 0, 20));
        this.modalityBox.setForeground(new Color(51, 51, 51));
        this.modalityBox.setBackground(new Color(242,242,242));
        this.modalityBox.addItem("Online");
        this.modalityBox.addItem("On-Site");
        this.modalityBox.addItem("Hybrid");

        // modality panel
        this.modalityPanel = new JPanel();
        this.modalityPanel.setLayout(new BoxLayout(this.modalityPanel, BoxLayout.X_AXIS));
        this.modalityPanel.setPreferredSize(new Dimension(400, 50));
        this.modalityPanel.setMaximumSize(new Dimension(400, 50));
        this.modalityPanel.setMinimumSize(new Dimension(400, 50));
        this.modalityPanel.add(modalityLbl);
        this.modalityPanel.add(Box.createHorizontalStrut(10));
        this.modalityPanel.add(modalityBox);
        ...
        // link label
        this.linkLbl = new JLabel("Link:");
        this.linkLbl.setPreferredSize(new Dimension(140, 50));
        this.linkLbl.setMaximumSize(new Dimension(140, 50));
        this.linkLbl.setMinimumSize(new Dimension(140, 50));
        this.linkLbl.setFont(new Font("Century Gothic", 0, 24));
        this.linkLbl.setForeground(new Color(51, 51, 51));

        // link text field
        this.linkTf = new JTextField();
        this.linkTf.setPreferredSize(new Dimension(660, 50));
        this.linkTf.setMaximumSize(new Dimension(660, 50));
        this.linkTf.setMinimumSize(new Dimension(660, 50));
        this.linkTf.setFont(new Font("Century Gothic", 0, 18));
        this.linkTf.setForeground(new Color(51, 51, 51)); 
        this.linkTf.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(new Color(51, 51, 51)),
                                    BorderFactory.createEmptyBorder(0, 10, 0, 10)));
        
        // link panel
        this.linkPanel = new JPanel();
        this.linkPanel.setLayout(new BoxLayout(this.linkPanel, BoxLayout.X_AXIS));
        this.linkPanel.setPreferredSize(new Dimension(810, 50));
        this.linkPanel.setMaximumSize(new Dimension(810, 50));
        this.linkPanel.setMinimumSize(new Dimension(810, 50));
        this.linkPanel.add(linkLbl);
        this.linkPanel.add(Box.createHorizontalStrut(10));
        this.linkPanel.add(linkTf);
        ...
        this.descriptionScrollPane.setPreferredSize(new Dimension(660, 70));
        this.descriptionScrollPane.setMaximumSize(new Dimension(660, 70));
        this.descriptionScrollPane.setMinimumSize(new Dimension(660, 70));
        ...
        this.descriptionPanel.setPreferredSize(new Dimension(810, 70)); 
        this.descriptionPanel.setMaximumSize(new Dimension(810, 70));
        this.descriptionPanel.setMinimumSize(new Dimension(810, 70));
        ...
        // modality & venue panel
        this.modalityVenuePanel = new JPanel();
        this.modalityVenuePanel.setLayout(new BoxLayout(this.modalityVenuePanel, BoxLayout.X_AXIS));
        this.modalityVenuePanel.setPreferredSize(new Dimension(810, 50));
        this.modalityVenuePanel.setMaximumSize(new Dimension(810, 50));
        this.modalityVenuePanel.setMinimumSize(new Dimension(810, 50));
        this.modalityVenuePanel.add(Box.createHorizontalGlue());
        this.modalityVenuePanel.add(modalityPanel);
        this.modalityVenuePanel.add(Box.createHorizontalStrut(20));
        this.modalityVenuePanel.add(venuePanel);
        this.modalityVenuePanel.add(Box.createHorizontalGlue());
        ...
        this.modalityVenuePanel.setAlignmentX(Component.CENTER_ALIGNMENT);
        this.linkPanel.setAlignmentX(Component.CENTER_ALIGNMENT);
        ...
        this.panel.add(Box.createRigidArea(new Dimension(0, 20))); 
        this.panel.add(modalityVenuePanel);
        this.panel.add(Box.createRigidArea(new Dimension(0, 20))); 
        this.panel.add(linkPanel);
        this.panel.add(Box.createRigidArea(new Dimension(0, 20))); 
    ...
    public String getSelectedModality() {
        return (String) this.modalityBox.getSelectedItem();
    }
    ...
    public void populateFields(Meeting entry) { // use for editing entries
        this.entryTitleTf.setText(entry.getTitle());
        this.venueTf.setText(entry.getVenue());
        this.linkTf.setText(entry.getLink());
        this.descriptionTa.setText(entry.getDetails());
        this.modalityBox.setSelectedItem(entry.getModality());
